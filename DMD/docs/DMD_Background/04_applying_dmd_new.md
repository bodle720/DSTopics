...
$$
X =
[\vec{x}_1 ; \vec{x}*2 ; \cdots ; \vec{x}*{m-1}]
$$
...
So DMD is trying to find one linear operator that approximately maps each frame to the next frame.
