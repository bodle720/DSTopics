...
Standard DMD assumes the snapshots are sampled at a constant, uniform timestep, so consecutive columns of the snapshot matrices should represent evenly spaced times.
