...
| DMD | See the [README](DMD/README.md) and the [notebook](DMD/DMD_pendulum_video.ipynb)            | Dynamic Mode Decomposition on synthetic pendulum video for mode analysis, reconstruction, forecasting, and foreground/background separation. |
