...
| DMD | See the [main README](DMD/README.md), the [main notebook](DMD/DMD_pendulum_video.ipynb), as well as the [course README](DMD/docs/DMD_Background/README.md) for notes on prerequisite topics. | Dynamic Mode Decomposition on synthetic pendulum video for mode analysis, reconstruction, forecasting, and foreground/background separation. |
