...
| DMD | [`DMD Pendulum Video`](DMD/DMD_pendulum.ipynb)                                                | Dynamic Mode Decomposition applied to financial time-series data as an exploratory sequential-modeling example. |
