...
| DMD | See the [main notebook](DMD/DMD_pendulum_video.ipynb), as well as the [README](DMD/README.md) and [prerequisite topics](DMD/docs/README_background.md) | Dynamic Mode Decomposition on synthetic pendulum video for mode analysis, reconstruction, forecasting, and foreground/background separation. |
