...
| DMD | See the [main notebook](DMD/DMD_pendulum_video.ipynb), as well as the README for the multiple prerequisite notes [here](DMD/doc/DMD_Background/README.md). | Dynamic Mode Decomposition on synthetic pendulum video for mode analysis, reconstruction, forecasting, and foreground/background separation. |
