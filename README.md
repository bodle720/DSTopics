...
| DMD | See the [main notebook](DMD/DMD_pendulum_video.ipynb), as well as the [README](DMD/README.md) and prerequisite topics review ([part 1](DMD/docs/crash_course_001.md) and [part 2](DMD/docs/crash_course_002.md)) | Dynamic Mode Decomposition on synthetic pendulum video for mode analysis, reconstruction, forecasting, and foreground/background separation. |
